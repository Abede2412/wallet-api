package tech.abede.walletapi.authentication.model;
...
public class UserPrincipal implements UserDetails {
    ...
    public static UserPrincipal build(ApplicationUser applicationUser) {
        return new UserPrincipal(applicationUser.getId(), applicationUser.getCustomer().getName(), applicationUser.getUsername(),
